...
async function addNumberToGoogleSheet ({ serialNum, number, outreachStatus, assessmentStatus }) {
  // Load GoogleDoc and Specific Sheet
  const sheet = await getSheet()
  // Add Number to Google Sheet
  const addRowResponse = await sheet.addRow({
    // 'Serial Number': serialNum,
    'timestamp': format(new Date(), 'MM/dd/yyyy@HH:MM'), // eslint-disable-line quote-props
